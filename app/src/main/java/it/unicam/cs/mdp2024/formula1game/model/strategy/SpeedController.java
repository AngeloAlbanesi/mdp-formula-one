...
/**
 * Controller per la gestione della velocità in base alle condizioni del circuito.
...
public class SpeedController {
     ...
     */
    public IVelocity calculateSafeVelocity(Position currentPos, Position nextPos, IVelocity currentVelocity) {
     ...
     */
    private boolean isTurning(Position currentPos, Position nextPos, IVelocity currentVelocity) {
